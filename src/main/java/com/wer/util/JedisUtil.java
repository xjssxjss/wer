...
public class JedisUtil {
    ...
    static {
        ...
        //redis未设置密码：
        jedisPool = new JedisPool(config, "192.168.0.100",Integer.parseInt("6379"));
    }
    ...
    public static void main(String[] args) {
        ...
        DictionaryEntries p1 = (DictionaryEntries) SerializeUtil.unserialize(personBy);
